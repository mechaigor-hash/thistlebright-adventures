...
main.book { min-height:100vh; padding:6mm 8mm 0; background:var(--paper2); }
...
.scene-plate.scene-full { min-height:297mm; margin:-6mm -8mm 0; page-break-before:auto; page-break-after:auto; }
.scene-plate.scene-full figure.art-plate { min-height:297mm; height:297mm; }
.scene-plate.scene-full figure.art-plate img { height:297mm; object-fit:cover; object-position:center; transform:scale(1.055); transform-origin:center; }
.scene-plate.step-overlay { margin-top:0; }
.scene-plate.step-overlay .scene-copy { bottom:7mm; }
.scene-plate.step-overlay .scene-copy h3 { clear:none; margin:0 0 1.4mm; padding:0 0 1mm; color:#76342c; font-size:16pt; line-height:1.05; font-variant:small-caps; letter-spacing:.02em; border:0; border-bottom:1px solid rgba(116,52,45,.35); background:none; }
...
.profile-card, .class-card { position:relative; clear:both; width:calc(100% + 16mm); min-height:297mm; margin:-6mm -8mm 0; padding:0; border:0; border-radius:0; overflow:hidden; box-shadow:none; break-inside:avoid; page-break-inside:avoid; page-break-before:auto; page-break-after:auto; background:#2e2418; }
.creature-card { position:relative; clear:both; width:calc(100% + 16mm); min-height:282mm; margin:0 -8mm 0; padding:0; border:0; border-radius:0; overflow:hidden; box-shadow:none; break-inside:avoid; page-break-inside:avoid; page-break-before:auto; page-break-after:auto; background:#2e2418; }
.profile-card > img, .class-card > img { position:relative; display:block; z-index:0; width:100%; height:311mm; max-width:none; max-height:none; margin:-7mm 0; padding:0; border:0; border-radius:0; object-fit:cover; object-position:center; opacity:.99; background:#2e2418; transform:scale(1.025); transform-origin:center; }
...
@media print { html, body { background:var(--paper2); } main.book { padding:6mm 8mm 0; } a { color:inherit; text-decoration:none; } figure.art-plate, .scene-plate, .profile-card, .class-card, .creature-card, blockquote, table { break-inside:avoid-page; page-break-inside:avoid; } }
'''
