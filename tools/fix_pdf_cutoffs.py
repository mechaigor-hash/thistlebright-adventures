...
figure.art-plate {
  clear:both; position:relative; width:calc(100% + 16mm); min-height:184mm; margin:3mm -8mm 4mm; padding:0;
...
figure.art-plate img { display:block; width:100%; height:184mm; max-height:none; object-fit:cover; object-position:center; border-radius:0; background:#2e2418; }
...
.scene-plate { position:relative; clear:both; width:calc(100% + 16mm); min-height:214mm; margin:3mm -8mm 4mm; padding:0; border:0; border-radius:0; overflow:hidden; box-shadow:none; break-inside:avoid; page-break-inside:avoid; page-break-before:auto; page-break-after:auto; background:#2e2418; }
.scene-plate figure.art-plate { position:relative; inset:auto; width:100%; min-height:214mm; height:214mm; margin:0; padding:0; border:0; border-radius:0; box-shadow:none; background:transparent; page-break-before:auto; page-break-after:auto; }
.scene-plate figure.art-plate::before { display:none; }
.scene-plate figure.art-plate img { width:100%; height:214mm; max-height:none; object-fit:cover; object-position:center; border-radius:0; opacity:.99; background:#2e2418; }
...
.profile-card, .class-card, .creature-card { position:relative; clear:both; width:calc(100% + 16mm); min-height:272mm; margin:3mm -8mm 4mm; padding:0; border:0; border-radius:0; overflow:hidden; box-shadow:none; break-inside:avoid; page-break-inside:avoid; page-break-before:auto; page-break-after:auto; background:#2e2418; }
.profile-card > img, .class-card > img { position:relative; display:block; z-index:0; width:100%; height:272mm; max-width:none; max-height:none; margin:0; padding:0; border:0; border-radius:0; object-fit:cover; object-position:center; opacity:.99; background:#2e2418; }
.creature-card figure.art-plate { position:relative; width:100%; min-height:272mm; height:272mm; margin:0; padding:0; border:0; border-radius:0; box-shadow:none; page-break-before:auto; page-break-after:auto; background:transparent; }
.creature-card figure.art-plate img { width:100%; height:272mm; max-height:none; object-fit:cover; object-position:center; padding:0; opacity:.99; background:#2e2418; }
